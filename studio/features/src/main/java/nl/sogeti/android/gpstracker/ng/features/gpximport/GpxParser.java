...
import nl.sogeti.android.gpstracker.utils.stream.UnicodeReader;
import timber.log.Timber;

import static nl.sogeti.android.gpstracker.service.util.TrackUriExtensionKt.tracksUri;
...
public class GpxParser {
    ...
    private static Long parseXmlDateTime(String text) {
        ...
        try {
            if (text == null) {
                throw new ParseException("Unable to parse dateTime null text", 0);
            }
                ...
                if (xmlParser.getName().equals(NAME_ELEMENT)) {
                    ...
                    if (xmlParser.getName().equals("trk") && trackUri == null) {
                        ...
                        for (int i = 0; i < 2; i++) {
                            ...
                            if (attributeName.equals(LATITUDE_ATTRIBUTE)) {
