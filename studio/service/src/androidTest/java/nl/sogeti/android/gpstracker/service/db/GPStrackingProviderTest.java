...
public class GPStrackingProviderTest extends ProviderTestCase2<GPStrackingProvider> {
    ...
    public GPStrackingProviderTest() {
        super(GPStrackingProvider.class, ContentConstants.GPS_TRACKS_AUTHORITY);
    ...
    public void testQuerySegmentsCursor() {
        Cursor cursor = this.mResolver.query(Uri.withAppendedPath(ContentConstants.Tracks.TRACKS_URI, "1/segments"), null, null, null,
                null);
    ...
    public void testQueryTracksCursor() {
        Cursor cursor = this.mResolver.query(ContentConstants.Tracks.TRACKS_URI, null, null, null, null);
        Assert.assertNotNull("Curson should not be null", cursor);
        Assert.assertTrue("Curson should be a cursor", cursor instanceof android.database.Cursor);
    ...
    public void testQueryWaypointsCursor() {
        Cursor cursor = this.mResolver.query(Uri.withAppendedPath(ContentConstants.Tracks.TRACKS_URI, "1/segments/1/waypoints"), null,
                null, null, null);
        Assert.assertNotNull("Curson should not be null", cursor);
        Assert.assertTrue("Curson should be a cursor", cursor instanceof android.database.Cursor);
    ...
    public void testStartTracks() {
        Uri firstTrack = Uri.parse(ContentConstants.Tracks.TRACKS_URI + "/1");
        Uri secondTrack = Uri.parse(ContentConstants.Tracks.TRACKS_URI + "/2");
        Uri newTrackUri;

        newTrackUri = this.mResolver.insert(ContentConstants.Tracks.TRACKS_URI, null);
    ...
    public void testStartTracksWithName() {
        ...
        values.put(ContentConstants.Tracks.NAME, testname);
        Uri newTrackUri = this.mResolver.insert(ContentConstants.Tracks.TRACKS_URI, values);

        Cursor trackCursor = this.mResolver.query(newTrackUri, new String[]{ContentConstants.Tracks.NAME}, null, null, null);
    ...
    public void testUpdateTrackWithName() {
        ...
        newTrackUri = this.mResolver.insert(ContentConstants.Tracks.TRACKS_URI, null);
        trackCursor = this.mResolver.query(newTrackUri, new String[]{ContentConstants.Tracks.NAME}, null, null, null);
        Assert.assertTrue("Should be possble to move to the first track", trackCursor.moveToFirst());
        Assert.assertEquals("This track runQuery should have 1 track", 1, trackCursor.getCount());
    ...
    public void testTrackAltitudeWaypoint() {
        ...
        wp.put(ContentConstants.Waypoints.LONGITUDE, Double.valueOf(200d));
        wp.put(ContentConstants.Waypoints.LATITUDE, Double.valueOf(100d));
        wp.put(ContentConstants.Waypoints.ALTITUDE, Double.valueOf(-123.456d));

        Uri trackUri = this.mResolver.insert(ContentConstants.Tracks.TRACKS_URI, null);
        ...
        Cursor waypointCursor = this.mResolver.query(waypoint, new String[]{ContentConstants.Waypoints.LONGITUDE, ContentConstants.Waypoints.LATITUDE,
                ContentConstants.Waypoints.ALTITUDE}, null, null, null);
    ...
    public void testTrackBearingWaypoint() {
        ...
        wp.put(ContentConstants.Waypoints.LONGITUDE, Double.valueOf(200d));
        wp.put(ContentConstants.Waypoints.LATITUDE, Double.valueOf(100d));
        wp.put(ContentConstants.Waypoints.BEARING, Float.valueOf(23.456f));
        ...
        Cursor waypointCursor = this.mResolver.query(waypoint, new String[]{ContentConstants.Waypoints.LONGITUDE, ContentConstants.Waypoints.LATITUDE,
                ContentConstants.Waypoints.BEARING}, null, null, null);
        Assert.assertEquals("This segment should list waypoints", 1, waypointCursor.getCount());
        Assert.assertTrue("Should be possble to move to the first waypoint", waypointCursor.moveToFirst());
        Assert.assertEquals("Longitude", 200d, waypointCursor.getDouble(0));
        Assert.assertEquals("Latitude", 100d, waypointCursor.getDouble(1));
    ...
    public void testTrackAccuracyWaypoint() {
        ...
        wp.put(ContentConstants.Waypoints.LONGITUDE, Double.valueOf(200d));
        wp.put(ContentConstants.Waypoints.LATITUDE, Double.valueOf(100d));
        wp.put(ContentConstants.Waypoints.ACCURACY, Float.valueOf(-123.456f));
        ...
        Cursor waypointCursor = this.mResolver.query(waypoint, new String[]{ContentConstants.Waypoints.LONGITUDE, ContentConstants.Waypoints.LATITUDE,
                ContentConstants.Waypoints.ACCURACY}, null, null, null);
        Assert.assertEquals("This segment should list waypoints", 1, waypointCursor.getCount());
        Assert.assertTrue("Should be possble to move to the first waypoint", waypointCursor.moveToFirst());
        Assert.assertEquals("Longitude", 200d, waypointCursor.getDouble(0));
        Assert.assertEquals("Latitude", 100d, waypointCursor.getDouble(1));
    ...
    public void testTrackWaypointWaypoint() {
        ...
        Cursor trackCursor = this.mResolver.query(segments, new String[]{ContentConstants.Segments._ID}, null, null, null);
        ...
        Uri waypoints = Uri.withAppendedPath(ContentConstants.Tracks.TRACKS_URI, "1/segments/" + segmentId + "/waypoints");
        Cursor waypointCursor = this.mResolver.query(waypoints, new String[]{ContentConstants.Waypoints.LONGITUDE, ContentConstants.Waypoints.LATITUDE
        }, null, null, null);
    ...
    public void testMakeTwoTracks() {
        ...
        values.put(ContentConstants.Tracks.NAME, testname + 1);
        trackOneUri = this.mResolver.insert(ContentConstants.Tracks.TRACKS_URI, values);
        ...
        wp.put(ContentConstants.Waypoints.LONGITUDE, Double.valueOf(coord));
        wp.put(ContentConstants.Waypoints.LATITUDE, Double.valueOf(coord));
        ...
        trackCursor = this.mResolver.query(trackOneUri, new String[]{ContentConstants.Tracks.NAME}, null, null, null);
        Assert.assertTrue("Should be possble to move to the first track", trackCursor.moveToFirst());
        Assert.assertEquals("This track runQuery should have 1 track", 1, trackCursor.getCount());
        ...
        values = new ContentValues();
        values.put(ContentConstants.Tracks.NAME, testname + 2);
        Uri trackTwoUri = this.mResolver.insert(ContentConstants.Tracks.TRACKS_URI, values);
        Cursor trackTwoCursor = this.mResolver.query(trackTwoUri, new String[]{ContentConstants.Tracks.NAME}, null, null, null);
        ...
        Cursor waypointsTwoCursor = this.mResolver.query(waypointsTwoUri, new String[]{ContentConstants.Waypoints.SEGMENT}, null,
                null, null);
    ...
    public void testDeleteEmptyTrack() {
        // E.g. returns: content://nl.sogeti.android.gpstracker/tracks/2
        Uri trackUri = this.mResolver.insert(ContentConstants.Tracks.TRACKS_URI, null);
        Cursor trackCursor = this.mResolver.query(trackUri, new String[]{ContentConstants.Tracks._ID}, null, null, null);
    ...
    public void testDeleteSimpleTrack() {
        ...
        Uri segmentUri = this.mResolver.insert(Uri.withAppendedPath(trackUri, "segments"), null);
        Cursor segmentCursor = this.mResolver.query(segmentUri, new String[]{ContentConstants.Segments._ID}, null, null, null);
    ...
    public void testDeleteSegmentedTrack() {
        ...
        for (int i = 0; i < 2; i++) {
            // E.g. returns: content://nl.sogeti.android.gpstracker/tracks/2/segments/1
            Uri segmentUri = this.mResolver.insert(Uri.withAppendedPath(trackUri, "segments"), null);
            segmentCursor[i] = this.mResolver.query(segmentUri, new String[]{ContentConstants.Segments._ID}, null, null, null);
    ...
    public void testWaypointTime() {
        ...
        wp.put(ContentConstants.Waypoints.TIME, Long.valueOf(msTime));
        ...
        Cursor waypointCursor = this.mResolver.query(waypointUri, new String[]{ContentConstants.Waypoints.TIME}, null, null, null);
    ...
    public void testInsertHighPrecisionAndExportHighPrecision() {
        ...
        ContentValues wp = new ContentValues();
        wp.put(ContentConstants.Waypoints.LONGITUDE, Double.valueOf(lon));
        wp.put(ContentConstants.Waypoints.LATITUDE, Double.valueOf(lat));
        wp.put(ContentConstants.Waypoints.TIME, Long.valueOf(1234567890000l));

        Uri trackUri = this.mResolver.insert(ContentConstants.Tracks.TRACKS_URI, null);
        Uri segmentUri = this.mResolver.insert(Uri.withAppendedPath(trackUri, "segments"), null);
        Uri waypointUri = this.mResolver.insert(Uri.withAppendedPath(segmentUri, "waypoints"), wp);

        Cursor waypointCursor = this.mResolver.query(waypointUri, new String[]{ContentConstants.Waypoints.LONGITUDE, ContentConstants.Waypoints
    ...
    public void testInsertMedia() {
        ...
        ContentValues wp = new ContentValues();
        wp.put(ContentConstants.Waypoints.LONGITUDE, Double.valueOf(37.8657d));
        wp.put(ContentConstants.Waypoints.LATITUDE, Double.valueOf(-122.305d));
        ...
        Cursor trackMedia = this.mResolver.query(trackMediaUri, new String[]{ContentConstants.Media.URI}, null, null, null);
        Cursor segmentMedia = this.mResolver.query(segmentMediaUri, new String[]{ContentConstants.Media.URI}, null, null, null);
        Cursor waypointMedia = this.mResolver.query(waypointsMediaUri, new String[]{ContentConstants.Media.URI}, null, null, null);
        ...
        args.put(ContentConstants.Media.URI, mediaInsertUri.toString());
        Uri mediaUri = this.mResolver.insert(mediaInsertUri, args);

        Assert.assertNotNull("Uri returned", mediaUri);
        Cursor media = this.mResolver.query(mediaUri, new String[]{ContentConstants.Media.URI}, null, null, null);
    ...
    public void testDeleteTrackWithMedia() {
        ...
        wp.put(ContentConstants.Waypoints.LATITUDE, Double.valueOf(-122.305d));
        ContentValues args = new ContentValues();
        args.put(ContentConstants.Media.URI, "a test");
        Uri trackUri = this.mResolver.insert(ContentConstants.Tracks.TRACKS_URI, null);
        Uri segmentUri = this.mResolver.insert(Uri.withAppendedPath(trackUri, "segments"), null);
        Uri waypointsUri = Uri.withAppendedPath(segmentUri, "waypoints");
        Uri waypointUri = this.mResolver.insert(waypointsUri, wp);
    ...
    public void testInsertMetaData() {
        ...
        Cursor trackMetaData = this.mResolver.query(trackMetaDataUri, new String[]{ContentConstants.MetaData.KEY, ContentConstants.MetaData.VALUE},
                null, null, null);
        Cursor segmentMetaData = this.mResolver.query(segmentMetaDatari, new String[]{ContentConstants.MetaData.KEY, ContentConstants.MetaData.VALUE},
                null, null, null);
        Cursor waypointMetaData = this.mResolver.query(waypointsMetaDataUri, new String[]{ContentConstants.MetaData.KEY, ContentConstants.MetaData
        ...
        Uri mediaUri;
        ContentValues args = new ContentValues();
        args.put(ContentConstants.MetaData.KEY, "A key");
        args.put(ContentConstants.MetaData.VALUE, "A value");

        metaDataInsertUri = Uri.withAppendedPath(waypointUri, "metadata");
        mediaUri = this.mResolver.insert(metaDataInsertUri, args);
        Assert.assertNotNull("Uri returned", mediaUri);

        metaData = this.mResolver.query(mediaUri, new String[]{ContentConstants.MetaData.KEY, ContentConstants.MetaData.VALUE}, null, null, null);
    ...
    public void testDeleteTrackWithMetaData() {
        ...
        wp.put(ContentConstants.Waypoints.LATITUDE, Double.valueOf(-122.305d));
        ContentValues args = new ContentValues();
        args.put(ContentConstants.MetaData.KEY, "a test");
        ...
        Cursor metadata = this.mResolver.query(ContentConstants.MetaData.METADATA_URI, new String[]{ContentConstants.MetaData.KEY, ContentConstants.MetaData.VALUE},
                null, null, null);
        ...
        Cursor trackMetadata = this.mResolver.query(trackMetaDataUri, new String[]{ContentConstants.MetaData.KEY, ContentConstants.MetaData.VALUE},
                null, null, null);
        Cursor segmentMetadata = this.mResolver.query(segmentMetaDataUri, new String[]{ContentConstants.MetaData.KEY, ContentConstants.MetaData.VALUE
        }, null, null, null);
        Cursor waypointMetadata = this.mResolver.query(waypointsMetaDataUri, new String[]{ContentConstants.MetaData.KEY, ContentConstants.MetaData
                .VALUE}, null, null, null);
        metadata.requery();
    ...
    public void testUpdateTrackWithMetaData() {
        ...
        ContentValues args = new ContentValues();
        args.put(ContentConstants.MetaData.KEY, "a test");
        args.put(ContentConstants.MetaData.VALUE, "firstvalue");
        Uri trackUri = this.mResolver.insert(ContentConstants.Tracks.TRACKS_URI, null);
        Uri segmentUri = this.mResolver.insert(Uri.withAppendedPath(trackUri, "segments"), null);
        Uri waypointsUri = Uri.withAppendedPath(segmentUri, "waypoints");
        Uri waypointUri = this.mResolver.insert(waypointsUri, wp);
        ...
        this.mResolver.insert(segmentMetaDataUri, args);
        this.mResolver.insert(waypointsMetaDataUri, args);
        Cursor metadata = this.mResolver.query(ContentConstants.MetaData.METADATA_URI, new String[]{ContentConstants.MetaData.VALUE}, null, null, null);
        Assert.assertTrue("Enough media", metadata.getCount() >= 3);

        args = new ContentValues();
        args.put(ContentConstants.MetaData.VALUE, "secondvalue");
        int trackRows = this.mResolver.update(trackMetaDataUri, args, ContentConstants.MetaData.KEY + " = ? ", new String[]{"a test"});
        int segmentRows = this.mResolver.update(segmentMetaDataUri, args, ContentConstants.MetaData.KEY + " = ? ", new String[]{"a " +
                "test"});
        int waypointRows = this.mResolver.update(waypointsMetaDataUri, args, ContentConstants.MetaData.KEY + " = ? ", new String[]{"a " +
                "test"});
        ...
        Cursor trackMetadata = this.mResolver.query(trackMetaDataUri, new String[]{ContentConstants.MetaData.VALUE}, ContentConstants.MetaData.KEY + "" +
                " = ? ", new String[]{"a test"}, null);
        Cursor segmentMetadata = this.mResolver.query(segmentMetaDataUri, new String[]{ContentConstants.MetaData.VALUE}, ContentConstants.MetaData.KEY
                + " = ? ", new String[]{"a test"}, null);
        Cursor waypointMetadata = this.mResolver.query(waypointsMetaDataUri, new String[]{ContentConstants.MetaData.VALUE}, ContentConstants.MetaData
